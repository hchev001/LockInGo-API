...
OasRails.configure do |config|
  ...
  config.info.title = 'LockinGo API Docs'
  config.info.version = '1.0.0'
  config.info.summary = 'Automatic Interactive API Documentation for LockinGo App'
  ...
  HEREDOC
  config.info.contact.name = 'Hamilton Chevez'
  config.info.contact.email = ''
  config.info.contact.url = 'https://hamiltonchevez.com'
